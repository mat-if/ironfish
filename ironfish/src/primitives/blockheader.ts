...
export class BlockHeaderSerde implements Serde<BlockHeader, SerializedBlockHeader> {
  ...
  equals(element1: BlockHeader, element2: BlockHeader): boolean {
    return (
      ...
      new NoteEncryptedHashSerde().equals(
        element1.noteCommitment.commitment,
        element2.noteCommitment.commitment,
      ) &&
  ...
  serialize(header: BlockHeader): SerializedBlockHeader {
    const serialized = {
      ...
      noteCommitment: {
        commitment: new NoteEncryptedHashSerde().serialize(header.noteCommitment.commitment),
  ...
  deserialize(data: SerializedBlockHeader): BlockHeader {
    ...
    const header = new BlockHeader(
      ...
      {
        commitment: new NoteEncryptedHashSerde().serialize(data.noteCommitment.commitment),
